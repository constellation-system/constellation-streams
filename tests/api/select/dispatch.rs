...
fn test_private_select_succeed() {
    ...
    assert!(inner.batches.try_borrow().expect("try_borrow failed").is_empty());
    assert!(inner.frags.try_borrow().expect("try_borrow failed").is_empty());
    assert!(inner.offers.try_borrow().expect("try_borrow failed").is_empty());
    assert!(inner.failures.is_empty());
    assert!(inner.reports.try_borrow().expect("try_borrow failed").is_empty());
    assert!(inner.batch_reports.try_borrow().expect("try_borrow failed").is_empty());
}
...
fn test_private_cancel_batch_succeed() {
    ...
    let res = stream.cancel_batch(&mut (), &mut (), &batch)
        .expect("Expected success");
...
fn test_private_cancel_batch_retry_succeed() {
    ...
    let res = stream.retry_cancel_batch(&mut (), &mut (), &batch, retry)
        .expect("Expected success");
...
fn test_private_cancel_batch_complete_complete() {
    ...
    let res = stream.complete_cancel_batch(&mut (), &mut (),
                                           &batch, completable)
        .expect("Expected success");
...
fn test_private_finish_batch_succeed() {
    ...
    let res = stream.finish_batch(&mut (), &mut (), &batch)
        .expect("Expected success");
...
fn test_private_finish_batch_retry_succeed() {
    ...
    let res = stream.retry_finish_batch(&mut (), &mut (), &batch, retry)
        .expect("Expected success");
...
fn test_private_finish_batch_complete_complete() {
    ...
    let res = stream.complete_finish_batch(&mut (), &mut (),
                                           &batch, completable)
        .expect("Expected success");
...
fn test_private_abort_start_batch_succeed() {
    ...
    assert!(stream.abort_start_batch(&mut (), &mut (), permanent).is_success());
...
fn test_private_abort_start_batch_retry_succeed() {
    ...
    assert!(
        stream.retry_abort_start_batch(&mut (), &mut (), retry).is_success()
    );
...
fn test_private_add_succeed() {
    ...
    let res = stream.add(&mut (), &mut (), &"hello", &batch)
        .expect("Expected success");
...
fn test_private_add_retry_succeed() {
    ...
    let res = stream.retry_add(&mut (), &mut (), &"hello", &batch, retry)
        .expect("Expected success");
...
fn test_private_frags_retry_succeed() {
    ...
    let res = stream.retry_push_frags(
        &mut (),
...
fn test_private_frags_complete_succeed() {
    ...
    let res = stream.complete_push_frags(
        &mut (),
        LargeObjID::from(1 as u64),
        &mut frags,
        completable
...
fn test_private_frags_complete_retry() {
    ...
    let retry = stream.complete_push_frags(
        &mut (),
        LargeObjID::from(1 as u64),
        &mut frags,
        completable
...
fn test_private_offer_retry_succeed() {
    ...
    let res = stream.retry_push_offer(&mut (), hash.clone(), &mut frags, retry)
        .expect("Expected success");
...
fn test_private_offer_complete_succeed() {
    ...
    let res = stream.complete_push_offer(
        &mut (),
        hash.clone(),
        &mut frags,
        completable
...
fn test_shared_select_succeed() {
    ...
    let res = if let RetryIndefResult::Success(res) =
